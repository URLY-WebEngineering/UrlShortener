...
public class ShortURLServiceTests {
    ...
    public void thatFindByKeyReturnsAURL() {
        ShortURL insertedURL1 = shortURLService.save(url1().getTarget(), url1().getSponsor(), url1().getIp(), url1().getQr() != null);
        ShortURL insertedURL2 = shortURLService.save(url3().getTarget(), url3().getSponsor(), url3().getIp(), url3().getQr() != null);
    ...
    public void thatFindByKeyReturnsAURLWithCustomBackhalf() throws BadCustomBackhalfException {
        ...
        ShortURL insertedURL1 = shortURLService.save(url1().getTarget(), url1().getSponsor(), custombackhalf, url1().getIp(), url1().getQr() != null);
    ...
    public void thatFindByKeyReturnsNullWhenFails() {
        shortURLService.save(url1().getTarget(), url1().getSponsor(), url1().getIp(), url1().getQr() != null);
        ShortURL su = shortURLService.findByKey(url2().getHash());
        assertNull(su);
    }

    @Test
    public void thatFindByKeyReturnsNullWhenFailsWithCustomBackhalf() throws BadCustomBackhalfException {
        String custombackhalf = "custombackhalf";
        shortURLService.save(url1().getTarget(), url1().getSponsor(), custombackhalf, url1().getIp(), url1().getQr() != null);
        ShortURL su = shortURLService.findByKey(url2().getHash());
        assertNull(su);
    }
    ...
    public void thatSaveWithCustomBackhalfNotConformsToPatternThrows() {
        ...
        Exception exception = assertThrows(BadCustomBackhalfException.class, () -> shortURLService.save(url1().getTarget(), url1().getSponsor(), custombackhalf, url1().getIp(), url1().getQr() != null));
        assertEquals("Backhalf should start with letters or numbers and be followed by letters, numbers, _ or -", exception.getMessage());
    }
    ...
    public void thatSaveDuplicateWithCustomBackhalfThrows() throws BadCustomBackhalfException {
        ...
        shortURLService.save(url1().getTarget(), url1().getSponsor(), custombackhalf, url1().getIp(), url1().getQr() != null);
        Exception e = assertThrows(BadCustomBackhalfException.class, () -> shortURLService.save(url3().getTarget(), url3().getSponsor(), custombackhalf, url3().getIp(), url3().getQr() != null));
