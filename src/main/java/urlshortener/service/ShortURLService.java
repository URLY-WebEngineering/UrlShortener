...
public class ShortURLService {
    ...
    public ShortURL save(String url, String sponsor, String custombackhalf, String ip, boolean wantQr) throws BadCustomBackhalfException {

        if (!backhalfConformsToPattern(custombackhalf)) {
            throw new BadCustomBackhalfException("Backhalf should start with letters or numbers and be followed by letters, numbers, _ or -");
