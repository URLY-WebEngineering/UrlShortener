...
public class SystemInformation {
    ...
    public List<Information> getInformation(){
        ...
        list.add(new Information("url.number",
                "Number of url shortened stored in the database",numURLs));
        list.add(new Information("clicks.number",
                "Number of clicks to urls stored in  the database",numClicks));
        list.add(new Information("users.number",
                "Number of users  on the database",numUsers));
        return list;
